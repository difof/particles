...
unitTest("test_file_dialog", { "extlib/imgui", "extlib/rlimgui", "extlib/raylib/src", "extlib/tinydir" }, { "src/render/ui/file_dialog.cpp", "extlib/imgui/imgui.cpp", "extlib/imgui/imgui_draw.cpp", "extlib/imgui/imgui_widgets.cpp", "extlib/imgui/imgui_tables.cpp", "extlib/imgui/misc/cpp/imgui_stdlib.cpp" })
